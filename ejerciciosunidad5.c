...
int main()
{
    ...
    printf("\nLa cantidad de primos encontrados es %d", contprimos);
}*/

/*ejercicio 5.1.13 opcion2*/
...
int main ()
{
    ...
    printf("\nEl articulo: %d ,que vale: %d es el producto mas caro. El articulo: %d, que vale: %d es el producto mas barato\n", codArtMayor, precioMayor, codArtMenor, precioMenor);
}*/
...
Los primeros datos a ingresar son la fecha (día, mes y año) y la cantidad de colegios de la ciudad en que se realizó la encuesta.
De cada colegio se conoce:
    número de escuela,
    la cantidad de alumnos inscriptos y
    la especialidad (‘T’: técnico, ‘N’: no técnico).
...
int main ()
{
    ...
    for(i=1;i<=cantidad_colegios;i++) /*Incio for colegios*/
    {
        c++;
